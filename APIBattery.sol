...
contract APIConsumer is ChainlinkClient {
    uint256 public _endBattery;
    uint256 public BatteryDecimal;
     ...
     */
    function fulfill(bytes32 _requestId, uint256 _percentRemaining)
        public
        recordChainlinkFulfillment(_requestId)
    {
        _endBattery = _percentRemaining / 1000;
        BatteryDecimal = _percentRemaining % 1000;
    }
